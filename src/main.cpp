 ...
 * ------------------------------------------------------------
 * Versao PlatformIO. O firmware e identico ao autorama/autorama.ino;
 * a unica diferenca e o #include <Arduino.h> abaixo (arquivos .cpp
 * nao incluem isso automaticamente como os .ino).
 *
 ...
 *   se voce parar de tocar, a velocidade CAI sozinha ate parar.
 *
 * Uso:
 *   1. pio run -t upload
